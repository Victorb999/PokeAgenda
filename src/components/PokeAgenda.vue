  ...
  <div class="pokeagenda-box-container">
    <b-jumbotron class="div-busca">
      <b-form inline @submit.prevent="BuscaPokemon(true)">
        ...
        <b-button @click="BuscaPokemon(true)" variant="success"
          >Search</b-button
        >
    ...
    <div class="containerpokemon" v-if="carregado">
      <b-jumbotron class="div-resultado">
        <Pokemon v-if="apistatus" :pokeresposta="pokeresposta" />
        <span v-else-if="!apistatus">
          {{ msg }}
        </span>
      </b-jumbotron>
    ...
    <div v-else class="loading">
      <img :src="pikachuLoad" alt="Loading" class="m-10" />
    </div>
  </div>
</template>
